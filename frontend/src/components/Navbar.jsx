    ...
    return (
        <div className=" flex justify-between py-2 border-b-2">
            <Link to={'/'} href="" className="flex items-center gap-1">
                ...
                <span className="font-bold ">Holiday.in </span>
            </Link>
            <div className="flex text-slate-600 font-semibold border-2 opacity-0 sm:opacity-100 rounded-full gap-4 py-3 px-4 shadow shadow-gray-200 ">
                <div >Hotels</div>
