            ...
            <form onSubmit={addNewplace} className="" >
                ...
                <div>
                    <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
                        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                            < input className=" border mt-1 py-1 rounded-xl" value="wifi" onChange={handlePerkChange} type="checkbox" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                            < input className=" border mt-1 py-1 rounded-xl" value="parking" onChange={handlePerkChange} type="checkbox" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                            < input className=" border mt-1 py-1 rounded-xl" value="Tv" onChange={handlePerkChange} type="checkbox" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                            < input className=" border mt-1 py-1 rounded-xl" value="pets" onChange={handlePerkChange} type="checkbox" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer" >
                            < input className=" border mt-1 py-1 rounded-xl" value="entrance" onChange={handlePerkChange} type="checkbox" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        < input className=" border mt-1 py-1 rounded-xl" value={maxguest} onChange={ev => {
